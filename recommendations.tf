module "recommendations" {
  ...
  environment_variables = [
    ...
    },
    {
      ...
      value = "nutrition-proteins.aws-ecs-cluster.local:30000"
    },
    {
      name  = "WATER_SERVICE_ENDPOINT"
      value = "nutrition-water.aws-ecs-cluster.local:30000"
    },
    {
      name  = "CALORIES_SERVICE_ENDPOINT"
      value = "nutrition-calories.aws-ecs-cluster.local:30000"
    },
    {
      name  = "RELEASE"
      value = timestamp()
