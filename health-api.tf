module "health_api" {
  ...
  service_hosts = [
    # "health.demo"
    "health.aws-ecs-cluster.internal.com"
  ]
  ...
  environment_variables = [
    {
      ...
      value = "http://jaeger-collector.aws-ecs-cluster.discovery.com:80"
    },
    {
      name  = "BMR_SERVICE_ENDPOINT",
      value = "nutrition-bmr.aws-ecs-cluster.discovery.com:30000"
    },
    {
      name  = "IMC_SERVICE_ENDPOINT",
      value = "nutrition-imc.aws-ecs-cluster.discovery.com:30000"
    },
    {
      name  = "RECOMMENDATIONS_SERVICE_ENDPOINT",
      value = "nutrition-recommendations.aws-ecs-cluster.discovery.com:30000"
    },
    {
      name  = "version"
      value = timestamp()
