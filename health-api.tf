module "health_api" {
  ...
  environment_variables = [
    ...
    },
    {
      ...
      value = "nutrition-bmr.aws-ecs-cluster.local:30000"
    },
    {
      name  = "IMC_SERVICE_ENDPOINT",
      value = "nutrition-imc.aws-ecs-cluster.local:30000"
    },
    {
      name  = "RECOMMENDATIONS_SERVICE_ENDPOINT",
      value = "nutrition-recommendations.aws-ecs-cluster.local:30000"
    },
    {
      name  = "RELEASE"
      value = timestamp()
